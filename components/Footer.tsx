  ...
  return (
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        {/* Logo and tagline */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-white mb-2">VOLVO CARS</h3>
          <p className="text-gray-400">Swedish Automotive Excellence</p>
        </div>

        {/* Footer columns - responsive grid layout */}
        {/* Mobile: 2 columns, Tablet: 3 columns, Desktop: 4 columns */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          {sections.map((section) => (
            <div key={section.title}>
              {/* Section heading */}
              <h4 className="text-lg font-semibold text-white mb-4 hover:text-volvo-blue transition">
                {section.title}
              </h4>
        ...
        <div className="border-t border-gray-700 pt-8 mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4">
              {/* Facebook */}
              <a
                href="https://facebook.com/volvo"
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-volvo-blue transition flex items-center justify-center"
              >
              ...
              {/* Instagram */}
              <a
                href="https://instagram.com/volvocars"
              ...
              {/* LinkedIn */}
              <a
                href="https://linkedin.com/company/volvo"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-volvo-blue transition flex items-center justify-center"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-400">
            {/* Copyright text */}
            <p>
              &copy; {currentYear} Volvo Car Corporation. All rights reserved.
            </p>
